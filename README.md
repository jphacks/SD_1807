...
誰もが一度はこんなことを思ったことがあるのではないでしょうか．<br>
...
「2分でアメリカ軍の96%の兵士が寝落ちした方法」を中心に，いくつかの睡眠に関する文献からの知識による睡眠のアドバイスを，スマートスピーカーの音声によってスキルを開発しました．スマートフォンのブルーライドを浴びることなく，ベットに横たわったまま音声によって操作できるので，快適に睡眠を導入できることが可能です．</br>
また，寝落ちを促進する事と逆の事をすることで，起きていたい時に居眠りを防止するスキルも開発しました．</br>
...
* Line Clova Developer Center βによる応答などの仕組みの開発
* AWS Lambda,AWS API GatewayによるAPIの開発と設定
=======
